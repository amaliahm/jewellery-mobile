...
class EleganceView extends StatelessWidget {
  final AnimationController animationController;

  const EleganceView({Key? key, required this.animationController})
      : super(key: key);
            ...
            children: [
              SlideTransition(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/images/elegance_image.png',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              ...
              SlideTransition(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    "Welcome to Bouzian Jewelry,\n where elegance meets style. Discover the perfect adornments that reflect your unique charm",
