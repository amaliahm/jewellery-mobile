...
class OnlyWilayas {
  final int id;
  final String wilaya_code;
  final String wilaya_name_ascii;

  OnlyWilayas(
      {required this.wilaya_code,
      required this.id,
      required this.wilaya_name_ascii});

  bool operator ==(Object other) =>
      identical(this, other) ||
      other is OnlyWilayas &&
          runtimeType == other.runtimeType &&
          id == other.id &&
          wilaya_name_ascii == other.wilaya_name_ascii;

  @override
  int get hashCode => id.hashCode ^ wilaya_name_ascii.hashCode;
}

class WilayaMenu {
  final int id;
  final String? commune_name_ascii;
  final String? commune_name;
  final String? daira_name_ascii;
  final String? daira_name;
  final String? wilaya_code;
  final String wilaya_name_ascii;
  final String? wilaya_name;

  WilayaMenu(
      {this.commune_name,
      this.commune_name_ascii,
      this.daira_name_ascii,
      this.daira_name,
      this.wilaya_name,
      this.wilaya_code,
      required this.id,
  ...
  static List<WilayaMenu> wilayas = [
    WilayaMenu(
        id: 22,
